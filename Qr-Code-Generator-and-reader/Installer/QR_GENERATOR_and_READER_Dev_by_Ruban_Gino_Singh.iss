...
AppId={{55F435B1-B45C-40DC-B8F8-B152B8A9FFCF}
AppName={#MyAppName}
...
LicenseFile=E:\GitHub\Python-Projects\LICENCE.txt
InfoBeforeFile=E:\GitHub\Python-Projects\INFO_Before.txt
InfoAfterFile=E:\GitHub\Python-Projects\INFO_After.txt
; Uncomment the following line to run in non administrative install mode (install for current user only.)
;PrivilegesRequired=lowest
OutputDir=E:\GitHub\Python-Projects
